    ...
    public static PDUMessage getMessage(BinaryMessage message, DataUnitID duid, AliasList aliasList)
    {
        ...
        switch(format)
        {
            case ALTERNATE_MULTI_BLOCK_TRUNKING_CONTROL:
                Vendor vendor = Vendor.fromValue(message.getInt(PDUMessage.VENDOR_ID));
                    ...
                    case STANDARD:
                        ...
                        switch(opcode)
                        {
                            ...
                            case RFSS_STATUS_BROADCAST:
                                return new RFSSStatusBroadcastExtended(message, duid, aliasList);
                            ...
                            case STATUS_UPDATE:
                                return new StatusUpdateExtended(message, duid, aliasList);
